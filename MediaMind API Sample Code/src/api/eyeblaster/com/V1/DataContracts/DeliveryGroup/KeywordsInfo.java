 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for AdditionalKeywords
                        */

                        
                                    protected java.lang.String localAdditionalKeywords ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAdditionalKeywordsTracker = false ;
                           ...
                           */
                           public  java.lang.String getAdditionalKeywords(){
                               return localAdditionalKeywords;
                           }
                            ...
                            /**
                               ...
                               * @param param AdditionalKeywords
                               */
                               public void setAdditionalKeywords(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localAdditionalKeywordsTracker = true;
                                       } else {
                                          localAdditionalKeywordsTracker = true;
                                              
                                       }
                                   
                                            this.localAdditionalKeywords=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       KeywordsInfo.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localAdditionalKeywordsTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"AdditionalKeywords", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"AdditionalKeywords");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("AdditionalKeywords");
                                    }
                                

                                          if (localAdditionalKeywords==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localAdditionalKeywords);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localAdditionalKeywordsTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/V1/DataContracts",
                                         ...
                                         elementList.add(localAdditionalKeywords==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAdditionalKeywords));
                                    } if (localKeywordsTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://api.eyeblaster.com/V1/DataContracts",
                                                                      "Keywords"));
    ...
    public static class Factory{
        ...
        */
        public static KeywordsInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            KeywordsInfo object =
                new KeywordsInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"KeywordsInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (KeywordsInfo)api.eyeblaster.com.message.DeliveryGroup.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.eyeblaster.com/V1/DataContracts","AdditionalKeywords").equals(reader.getName())){
