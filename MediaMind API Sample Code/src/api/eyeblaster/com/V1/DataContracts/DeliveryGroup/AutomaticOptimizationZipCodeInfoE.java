...
/**
 * AutomaticOptimizationZipCodeInfoE.java
 *
 ...
 */
            ...
            /**
            *  AutomaticOptimizationZipCodeInfoE bean class
            */
        
        public  class AutomaticOptimizationZipCodeInfoE
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       AutomaticOptimizationZipCodeInfoE.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                                      ...
                                      if (localAutomaticOptimizationZipCodeInfo==null){
                                        ...
                                        if (! namespace.equals("")) {
                                            ...
                                            if (prefix == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix,"AutomaticOptimizationZipCodeInfo", namespace);
                                                xmlWriter.writeNamespace(prefix, namespace);
                                                xmlWriter.setPrefix(prefix, namespace);

                                            } else {
                                                xmlWriter.writeStartElement(namespace,"AutomaticOptimizationZipCodeInfo");
                                            }
                                        ...
                                        xmlWriter.writeEndElement();
                                         ...
                                         localAutomaticOptimizationZipCodeInfo.serialize(MY_QNAME,factory,xmlWriter);
                                       }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localAutomaticOptimizationZipCodeInfo==null){
                                   ...
                                   return localAutomaticOptimizationZipCodeInfo.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static AutomaticOptimizationZipCodeInfoE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AutomaticOptimizationZipCodeInfoE object =
                new AutomaticOptimizationZipCodeInfoE();
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://api.eyeblaster.com/V1/DataContracts","AutomaticOptimizationZipCodeInfo").equals(reader.getName())){
                                      ...
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setAutomaticOptimizationZipCodeInfo(null);
                                          reader.next();
                                          
                                      }else{
                                    
                                                object.setAutomaticOptimizationZipCodeInfo(api.eyeblaster.com.V1.DataContracts.DeliveryGroup.AutomaticOptimizationZipCodeInfo.Factory.parse(reader));
                                            }
